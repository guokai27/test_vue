<template>
  <div>
    ...
    <h1 class="header-title">大屏数据可视化测试用例</h1>
        ...
        <div class="col col-l">
          <div class="xpanel-wrapper xpanel-wrapper-40">
            <div class="xpanel xpanel-l-t">
              <!--<div class="title title-long">流量汇总</div>-->
        ...
        <div class="col col-c">
          ...
          <div class="xpanel-wrapper xpanel-wrapper-25">
            <div class="xpanel xpanel-c-b">
              <!--<div class="title title-long">中</div>-->
        ...
        <div class="col col-r">
          <div class="xpanel-wrapper xpanel-wrapper-25">
            <div class="xpanel xpanel-r-t">
              <!--<div class="title">右1</div>-->

            </div>
          </div>
          <div class="xpanel-wrapper xpanel-wrapper-30">
            <div class="xpanel xpanel-r-m">
              <!--<div class="title">右2</div>-->
              <!--   <Top_N2 class="fill-h"></Top_N2>-->
            </div>
          </div>
          <div class="xpanel-wrapper xpanel-wrapper-45">
            <div class="xpanel xpanel-r-b">
              <div class="title">右三</div>
            </div>
          </div>
        </div>
      </div>
    </div>
    <!--<el-button type="text" class="button" @click="screenfull">{{msg}}</el-button>
    <a :href='"#/"' style="color: #12a7ff">
      主页
    </a>-->
  </div>
</template>
